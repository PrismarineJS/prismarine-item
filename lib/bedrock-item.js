      ...
      if (item1 == null && item2 == null) {
        ...
        return (
          item1.type === item2.type &&
            ...
            (matchNbt ? item1.canPlaceOn.sort().toString() === item2.canPlaceOn.sort().toString() : true) &&
            (matchNbt ? item1.canDestroy.sort().toString() === item2.canDestroy.sort().toString() : true)
        )
      }
    }
