...
describe('1.8.9 anvil', () => {
  ...
  it('combine two damaged sword', () => {
    ...
    finalItem.stackId = res.item.stackId
    inverseFinalItem.stackId = inverse.item.stackId
  ...
  describe('too expensive test', () => {
    ...
    it('try renaming', () => {
      ...
      expectedItem.stackId = res.item.stackId
...
describe('1.16.5 anvil', () => {
  ...
  it('gold helmets', () => {
    ...
    expectedItem.stackId = anvil.item.stackId
    expectedInverseItem.stackId = inverse.item.stackId
  ...
  it('two fully fixed diamond swords', () => {
    ...
    resItem.stackId = anvil.item.stackId
    ...
    describe('Enchantment Order Diagram', () => { // this test is from https://minecraft.gamepedia.com/File:Enchantment_Order_Diagram.png
      ...
      describe('first combine', () => {
        it('enchant boot+ss3', () => {
          ...
          eqItem.stackId = res.item.stackId
